...
function Home() {
    ...
    return (
        <div className="min-h-screen bg-base-200"> {/* Same background as product page */}
            <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8"> {/* Centered content like product page */}
