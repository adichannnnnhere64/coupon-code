...
// ✅ Your existing plans
const plans = [
  { id: 'basic', name: 'Basic', price: 149, data: '1GB', speed: '10Mbps', popular: false },
  { id: 'standard', name: 'Standard', price: 299, data: '2GB', speed: '50Mbps', popular: true },
  { id: 'premium', name: 'Premium', price: 499, data: '5GB', speed: '100Mbps', popular: false },
  { id: 'unlimited', name: 'Unlimited', price: 799, data: 'Unlimited', speed: '500Mbps+', popular: false },
]
...
const ImageGallery: React.FC<{ images: string[]; mainImage: string }> = ({ images, mainImage }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 space-y-2">
                ...
                <Link to="/" className="btn btn-square w-20">
                    <svg width="48" height="48" className="w-4" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-4">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-2 text-sm sm:text-base text-base-content/70">
                    Code: <span className="font-mono bg-base-200 px-3 py-1 rounded-full text-sm">{coupon.coupon_code}</span> •{' '}
              ...
              <div className="bg-base-200/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-base-300/30">
                <p className="text-base-content/80 leading-relaxed">
                  Instant mobile recharge with exclusive discount. Valid across all circles for {coupon.plan_type.name} plans.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50/80 to-teal-50/80 rounded-2xl p-6 border border-emerald-200/30 backdrop-blur-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <div>
                  <p className="text-sm font-medium text-emerald-700 uppercase tracking-wide">Selected Plan</p>
                  <p className="text-xl sm:text-2xl font-bold text-base-content mt-1">{selectedPlan.name}</p>
                ...
                <div className="text-right">
                  <p className="text-3xl sm:text-4xl font-bold text-emerald-600">${selectedPlan.price}</p>
                  <p className="text-sm text-base-content/70 mt-1">per recharge</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-base-100 rounded-2xl shadow-2xl w-full max-w-md p-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-base-200 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold truncate">{coupon.operator.name}</h3>
                  <p className="text-sm text-base-content/70 truncate">{selectedPlan.name}</p>
                </div>
                <div className="text-right">
