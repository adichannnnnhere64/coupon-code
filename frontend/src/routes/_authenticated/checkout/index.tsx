...
const CheckoutPage: React.FC = () => {
  ...
  const search = useSearch({ from: '/_authenticated/checkout/' }) as CheckoutSearchParams;
  ...
  const [couponTransaction, setCouponTransaction] = useState<CouponTransaction | null>(null);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span>Operator:</span>
                        <span className="font-medium">{couponTransaction.operator}</span>
                      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
              ...
              <Link to="/profile/orders" className="btn btn-outline btn-lg flex-1 h-14 text-lg">
                View Orders
              </Link>
            </div>
          </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-rose-50">
        <div className="text-center max-w-md mx-auto p-8 bg-white rounded-2xl shadow-xl">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Missing Order Details</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className={`flex items-center gap-2 ${step === 'payment-methods' || step === 'processing' ? 'text-primary' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${
              ...
              <div className="flex items-center gap-6 p-6 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl border border-primary/20">
                <div className="relative w-24 h-24 rounded-xl overflow-hidden shadow-lg">
                  <div className="w-full h-full bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center">
                    <span className="font-mono text-lg font-bold text-white/80">COUPON</span>
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 mt-1 truncate">{planName}</p>
                  <p className="text-xs text-gray-500 mt-2">
                    Coupon ID: <span className="font-mono bg-gray-100 px-2 py-1 rounded-md">
                      #{couponId}
                    </span>
                  </p>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center">
                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm2 6a1 1 0 110-2 1 1 0 010 2zm7-1a1 1 0 10-2 0 1 1 0 002 0zm2-3a1 1 0 110 2 1 1 0 010-2z" clipRule="evenodd" />
                        </svg>
                      </div>
                      <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-lg font-bold text-purple-600">${amount}</span>
